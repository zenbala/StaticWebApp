                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold"><span className='font-black'>Why Yugam HR Services??</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                Helping your business grow through strategic HR solutions and talent placement.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>Creating impactful teams by matching exceptional talent with your business needs.</p>
                            </div>
                        </div>
                    </div>
                </div>
